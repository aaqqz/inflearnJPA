...
public class MemberApiController {
    ...
    public CreateMemberResponse saveMemberV1(@RequestBody @Valid Member member) { // @Valid MemberEntity 에서 javax.validation 어노테이션 검증
    ...
    public CreateMemberResponse saveMemberV2(@RequestBody @Valid CreateMemberRequest request) {
        ...
        member.setAddress(new Address(request.getCity(), null, null));
    ...
    @GetMapping("/api/v1/members") // Entity 반환하면 안됨 ex) api 스펙 바뀌면 큰일
