...
class MemberJpaRepositoryTest {
    ...
    public void hasText() throws Exception{
        ...
        System.out.println("testA = " + StringUtils.hasText(testA)); // true
        System.out.println("testB = " + StringUtils.hasText(testB)); // false
        System.out.println("testC = " + StringUtils.hasText(testC)); // false
    }
}