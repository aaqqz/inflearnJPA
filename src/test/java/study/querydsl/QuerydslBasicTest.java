...
public class QuerydslBasicTest {
    ...
    public void fetchJoinNo() throws Exception {
        ...
        boolean loaded = emf.getPersistenceUnitUtil().isLoaded(findMember.getTeam()); // 로딩된 엔티티인지 검증 (초기화된 엔티티 인지 검증)
    ...
    @Test
    public void findByDtoQuerydslSetter() throws Exception{
    ...
    @Test
    public void findByDtoQuerydslField() throws Exception{
        List<MemberDto> result = queryFactory
    ...
    @Test
    public void findByDtoQuerydslConstructor() throws Exception{
        List<MemberDto> result = queryFactory
    ...
    @Test
    public void findByUserDtoQuerydslField() throws Exception{
        QMember memberSub = new QMember("memberSub");
    ...
    @Test
    public void findByUserDtoQuerydslConstructor() throws Exception{
        List<UserDto> result = queryFactory
    ...
    public void bulkUpdate() throws Exception{
        ...
        // 벌크 연산후 DB와 영속성컨텍스트 값의 차이가 존재하기 때문에 초기화 한다
        em.flush();
        em.clear();
